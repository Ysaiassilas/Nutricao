...
    // Tenta carregar os dados da última avaliação e do usuário do localStorage
    const resultadoAvaliacao = JSON.parse(localStorage.getItem('ultimaAvaliacao'));
...
                pontuacaoUsuarioSpan.textContent = resultadoAvaliacao.pontuacao || 'N/A';
            }
